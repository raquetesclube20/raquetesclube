...
export default function InstagramFeed() {
  ...
  return (
    <section className="relative py-20 bg-dark-bg border-b border-white/5" id="instagram-clube">
      ...
      <div className="absolute top-[30%] right-[-10%] w-[35%] h-[35%] bg-pink-500/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 text-left">
          <div>
            <span className="text-xs font-mono tracking-[0.2em] text-pink-500 uppercase block mb-3 animate-pulse">
              • CONEXÃO INSTAGRAM ONLINE •
            </span>
            <h3 className="font-display font-black text-2xl sm:text-3xl md:text-4xl text-white tracking-tight">
              Siga-nos <span className="text-pink-500 font-extrabold">@raquetesclube</span> no Instagram
            </h3>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-5 py-3.5 rounded-xl bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 hover:opacity-90 text-white text-xs font-bold uppercase tracking-wider flex items-center gap-2 cursor-pointer transition-all shadow-lg shadow-pink-500/10 shrink-0"
          >
